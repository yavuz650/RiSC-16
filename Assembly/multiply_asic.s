## RiSC-16 assembly multiplication algorithm (ASIC)
## by Yavuz Selim Tozlu

#begin
	lw 		r1,r0,a #r1=a , multiplicand
	lw 		r2,r0,b #r2=b , multiplier
	addi	r5,r0,0 #result is stored in r5
...
loop1: beq 	r0,r3,done #are we done?
...
done: sw	r5,r0,0 #store result in data memory address zero
done2: beq	r0,r0,done2
